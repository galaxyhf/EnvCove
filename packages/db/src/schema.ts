...
export const environments = pgTable("environments", {
  ...
  description: text("description").notNull().default(""),
  ...timestamps,
}, (table) => [uniqueIndex("environments_project_slug_unique").on(table.projectId, table.slug)]);
...
export const secrets = pgTable("secrets", {
  ...
  uniqueIndex("secrets_environment_key_unique").on(table.environmentId, table.key),
...
}, (table) => [uniqueIndex("cli_tokens_hash_unique").on(table.tokenHash), index("cli_tokens_user_id_idx").on(table.userId)]);
